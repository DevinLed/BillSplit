...
export default function AddPerson4({
  personName4,
  personPhone4,
  personEmail4,
  personOwing4,
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10 mb-0">
                    <input
                      ...
                      id="colFormLabel"
                      placeholder="Name"
                      onChange={(e) => setPersonName4(e.target.value)}
                    />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input
                      ...
                      onChange={(e) => setPersonPhone4(e.target.value)}
                    />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input
                      ...
                      class="form-control"
                      placeholder="Email"
                      onChange={(e) => setPersonEmail4(e.target.value)}
                    />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input
                      ...
                      placeholder="0.00"
                      onChange={(e) => setPersonOwing4(e.target.value)}
                    />

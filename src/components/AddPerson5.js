...
export default function AddPerson5({
  personName5,
  personPhone5,
  personEmail5,
  personOwing5,
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10 mb-0">
                    <input
                      ...
                      id="colFormLabel"
                      placeholder="Name"
                      onChange={(e) => setPersonName5(e.target.value)}
                    />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input
                      ...
                      onChange={(e) => setPersonPhone5(e.target.value)}
                    />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input
                      ...
                      class="form-control"
                      placeholder="Email"
                      onChange={(e) => setPersonEmail5(e.target.value)}
                    />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input
                      ...
                      placeholder="0.00"
                      onChange={(e) => setPersonOwing5(e.target.value)}
                    />

...
export default function AddPerson3({
  personName3,
  personPhone3,
  personEmail3,
  personOwing3,
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10 mb-0">
                    <input
                      ...
                      id="colFormLabel"
                      placeholder="Name"
                      onChange={(e) => setPersonName3(e.target.value)}
                    />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input
                      ...
                      onChange={(e) => setPersonPhone3(e.target.value)}
                    />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input
                      ...
                      class="form-control"
                      placeholder="Email"
                      onChange={(e) => setPersonEmail3(e.target.value)}
                    />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input
                      ...
                      placeholder="0.00"
                      onChange={(e) => setPersonOwing3(e.target.value)}
                    />
